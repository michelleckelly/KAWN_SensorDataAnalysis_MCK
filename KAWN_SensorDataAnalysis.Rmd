...
## Difference in N with time (include in talk)
```{r Nderiv, fig.height=3, fig.width=10}
plot(diff(bowersock_N$`Nitrate plus nitrite as mg-N/L`, lag = 1, differences = 1,
...
mm <- metab_bayes(specs = bayes_specs, data = desoto_MetabData_GH)
mm
predict_metab(mm)
