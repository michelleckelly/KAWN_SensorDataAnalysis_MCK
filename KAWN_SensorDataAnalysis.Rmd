...
steve_metab$dateTime <- steve_metab$dateTime - dminutes(4)
...
# [7] load river metabolism function 
...
# [8] run metabolism model

# time period 2: Feb 20-22
rivermetabK(o2file = steve_metab, z = mean(steve_metab$z), bp = mean(steve_metab$bp), 
            ts = 0.02083333)

steve_metab[steve_metab$dateTime]
