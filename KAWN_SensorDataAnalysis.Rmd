...
plot(y = steve_DO$DO_mgL, x = steve_DO$time_CST)
...
steve_metab_output <- rivermetabK(o2file = steve_metab, 
                                  z = mean(steve_metab$z, na.rm = TRUE), 
                                  bp = mean(steve_metab$bp, na.rm = TRUE), 
                                  ts = 0.02083333)
steve_metab_output

# omit sensor burial days, will have to play with this
eric_metab_output <- rivermetabK(o2file = eric_metab, 
                                  z = mean(eric_metab$z, na.rm = TRUE), 
                                  bp = mean(eric_metab$bp, na.rm = TRUE), 
                                  ts = 0.02083333)
eric_metab_output

# time period 1: Feb 3-6
steve_metab_period1 <- steve_metab[steve_metab$dateTime 
                             %between% 
                               c(ymd_hms("2018-02-03 00:00:00", tz = "America/Chicago"),
                                 ymd_hms("2018-02-05 00:00:00", tz = "America/Chicago")),]
steve_metab_output_period1 <- rivermetabK(o2file = steve_metab_period1, 
                                          z = mean(steve_metab_period1$z, na.rm = TRUE), 
                                          bp = mean(steve_metab_period1$bp), 
                                          ts = 0.02083333)
steve_metab_output_period1

# time period 2: Feb 20-22
steve_metab_period2 <- steve_metab[steve_metab$dateTime 
                             %between% 
                               c(ymd_hms("2018-02-20 00:00:00", tz = "America/Chicago"),
                                 ymd_hms("2018-02-22 00:00:00", tz = "America/Chicago")),]
steve_metab_output_period2 <- rivermetabK(o2file = steve_metab_period2, 
                                          z = mean(steve_metab_period2$z), 
                                          bp = mean(steve_metab_period2$bp), 
                                          ts = 0.02083333)
steve_metab_output_period2

eric_metab_period2 <- eric_metab[eric_metab$dateTime 
                             %between% 
                               c(ymd_hms("2018-02-20 00:00:00", tz = "America/Chicago"),
                                 ymd_hms("2018-02-22 00:00:00", tz = "America/Chicago")),]
eric_metab_output_period2 <- rivermetabK(o2file = eric_metab_period2, 
                                          z = mean(eric_metab_period2$z), 
                                          bp = mean(eric_metab_period2$bp), 
                                          ts = 0.02083333)
eric_metab_output_period2

# time period 3: Mar 22-25
steve_metab_period3 <- steve_metab[steve_metab$dateTime 
                             %between% 
                               c(ymd_hms("2018-03-22 00:00:00", tz = "America/Chicago"),
                                 ymd_hms("2018-03-25 00:00:00", tz = "America/Chicago")),]
steve_metab_output_period3 <- rivermetabK(o2file = steve_metab_period3, 
                                          z = mean(steve_metab_period3$z), 
                                          bp = mean(steve_metab_period3$bp), 
                                          ts = 0.02083333)
steve_metab_output_period3

eric_metab_period3 <- eric_metab[eric_metab$dateTime 
                             %between% 
                               c(ymd_hms("2018-03-22 00:00:00", tz = "America/Chicago"),
                                 ymd_hms("2018-03-25 00:00:00", tz = "America/Chicago")),]
eric_metab_output_period3 <- rivermetabK(o2file = eric_metab_period3, 
                                          z = mean(eric_metab_period3$z), 
                                          bp = mean(eric_metab_period3$bp), 
                                          ts = 0.02083333)
eric_metab_output_period3

# time period 5: Apr 11-13 - dont yet have neon PAR for april!!
steve_metab_period5 <- steve_metab[steve_metab$dateTime 
                             %between% 
                               c(ymd_hms("2018-04-11 00:00:00", tz = "America/Chicago"),
                                 ymd_hms("2018-04-13 00:00:00", tz = "America/Chicago")),]
steve_metab_output_period5 <- rivermetabK(o2file = steve_metab_period5, 
                                          z = mean(steve_metab_period5$z), 
                                          bp = mean(steve_metab_period5$bp), 
                                          ts = 0.02083333)
steve_metab_output_period5
```
