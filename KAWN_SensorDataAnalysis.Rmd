...
bayes_name <- mm_name(type = "bayes", pool_K600 = "binned", ode_method = "trapezoid")
bayes_specs <- specs(bayes_name) 
bayes_specs <- revise(bayes_specs, burnin_steps=100, saved_steps=100,
                      split_dates = FALSE, verbose = TRUE) 
# steps are low for practice
