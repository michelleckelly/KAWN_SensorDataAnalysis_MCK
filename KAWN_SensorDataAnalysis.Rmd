...
grid.arrange(
  ...
  ggplot(ericN_daynightdiff, aes(x = `Date and time`, y = perc, color = "Site 4")) +
  geom_line(size = 2) +
  theme_classic() +
  xlab(NULL) +
  ylab(NULL) +
...
NMetabComp_eric <- merge(ericN_daynightdiff, metabmodels_eric_results, 
                         by = "date")
NMetabComp_eric$perc <- abs(NMetabComp_eric$perc)
...
NMetabComp_steve <- merge(steveN_daynightdiff, metabmodels_steve_results, 
                          by = "date")
NMetabComp_steve$perc <- abs(NMetabComp_steve$perc)
...
NMetabComp_desoto <- merge(desotoN_daynightdiff, metabmodels_desoto_results,
                           by = "date")
NMetabComp_desoto$perc <- abs(NMetabComp_desoto$perc)
...
# GPP plot
ggplot(NULL) +
  geom_point(data = NMetabComp_eric, 
             aes(x = GPP, y = perc, color = "Site 2", shape = "19", size = 2), 
             show.legend = FALSE) +
  geom_point(data = NMetabComp_steve, 
             aes(x = GPP, y = perc, color = "Site 3", shape = "17", size = 2), 
             show.legend = FALSE) +
  geom_point(data = NMetabComp_desoto, 
...
predicted_temp_GPP <- data.frame(
  temppred = predict.lm(lm(lm_data_GPP_temp$temp~lm_data_GPP_temp$GPP), lm_data_GPP_temp), 
  GPP = lm_data_GPP_temp$GPP
  )
...
ggplot(NULL) +
  geom_point(data = NMetabComp_eric_summary, 
             aes(x = GPP, y = mean_temp, color = "Site 2", shape = "19", size = 2), 
             show.legend = FALSE) +
  ...
  geom_point(data = NMetabComp_steve_summary, 
             aes(x = GPP, y = mean_temp, color = "Site 3", shape = "17", size = 2), 
             show.legend = FALSE) +
  geom_errorbar(data = NMetabComp_steve_summary, 
                aes(x = GPP, ymin = mean_temp-sd_temp, ymax = mean_temp+sd_temp)) +
  geom_point(data = NMetabComp_desoto_summary, 
             aes(x = GPP, y = mean_temp, color = "Site 4", shape = "15", size = 2), 
             show.legend = FALSE) +
  geom_errorbar(data = NMetabComp_desoto_summary, 
                aes(x = GPP, ymin = mean_temp-sd_temp, ymax = mean_temp+sd_temp)) +
  geom_line(data = predicted_temp_GPP, aes(y = temppred, x = GPP)) +
  theme_classic() +
  xlab("gpp") +
  ylab("temp") +
  #coord_cartesian(x = c(0,5), y = c(-2,2)) +
...
NMetabComp_eric_before1Apr <- NMetabComp_eric[NMetabComp_eric$`Date and time`<mdy_hms("04-01-2018 00:00:00"),]
NMetabComp_steve_before1Apr <- NMetabComp_steve[NMetabComp_steve$`Date and time`<mdy_hms("04-01-2018 00:00:00"),]
NMetabComp_desoto_before1Apr <- NMetabComp_desoto[NMetabComp_desoto$dateTime<mdy_hms("04-01-2018 00:00:00"),]
...
# GPP: post 1 Apr
NMetabComp_eric_after1Apr <- NMetabComp_eric[NMetabComp_eric$`Date and time`>mdy_hms("04-01-2018 00:00:00"),]
NMetabComp_steve_after1Apr <- NMetabComp_steve[NMetabComp_steve$`Date and time`>mdy_hms("04-01-2018 00:00:00"),]
NMetabComp_desoto_after1Apr <- NMetabComp_desoto[NMetabComp_desoto$dateTime>mdy_hms("04-01-2018 00:00:00"),]
