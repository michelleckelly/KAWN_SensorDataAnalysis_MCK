...
steve_metab <- 
as.data.frame(
  ymd_hms(steve_DO$time_CST, tz = "America/Chicago")
)
names(steve_metab) <- "Date"
...
steve_metab$DOsat <- steve_DO$DO_sat
...
steve_alt <- 249.02 # m
BarPress$mean_steve <- bpcalc(bpst = BarPress$mean, alt = steve_alt)
...
steve_metab$K600 <- K600fromO2(temp = )
```
