...
FarmlandPumpingLogs$flowRate_Outfall001A_gpm <- gpm_Ls(FarmlandPumpingLogs$flowRate_Outfall001A_gpm)
names(FarmlandPumpingLogs)[names(FarmlandPumpingLogs) == "flowRate_Outfall001A_gpm"] <-
  "flowRate_Outfall001A_L.s"

FarmlandPumpingLogs$flowRate_AveragePump_gpm <- gpm_Ls(FarmlandPumpingLogs$flowRate_AveragePump_gpm)
...
# NEON Data (In development)  

## Data Pull (In development)  
...
```{r waterBalancePlotting, include=TRUE, fig.height=3, fig.width=10, warning=FALSE}
...
waterBal_plot <- ggplot() +
  ...
  labs(y = "Difference between downstream 
       flow gauge and upstream flow gauge, L/s",
       x = "Date", 
...
## All Sites: Nitrate plus Nitrite Plot  

```{r NmergedPlot, include=TRUE, warning=FALSE, fig.height=6, fig.width=10}
...
## Individual Sites: DO, Temp, N Plots  
...
```{r bowersockPlots, include=TRUE, warning=FALSE, fig.height=3, fig.width=10}
...
```{r FarmlandPumpLogsPlots, include=TRUE, warning=FALSE, fig.height=3, fig.width=10}
...
```{r Period1Plot, include=TRUE, fig.height=9, fig.width=5}
...
```{r Period1ComboPlot, include=TRUE, fig.height=9, fig.width=15}
...
```{r Period2Plot, include=TRUE, fig.height=9, fig.width=5}
...
```{r Period2ComboPlot, include=TRUE, fig.height=9, fig.width=15}
...
```{r Period3Plot, include=TRUE, fig.height=9, fig.width=5}
...
```{r Period3ComboPlot, include=TRUE, fig.height=9, fig.width=15}
...
```{r Period4Plot, include=TRUE, fig.height=9, fig.width=5}
...
```{r Period5Plot, include=TRUE, fig.height=9, fig.width=5}
