...
eric_N$`Nitrate plus nitrite as mg-N/L`[eric_N$`Date and time` 
                                         %between% 
                                           c(ymd_hms("2018-03-05 00:00:00", tz = "America/Chicago"),
                                             ymd_hms("2018-03-15 11:00:00", tz = "America/Chicago"))] <- NA
...
plot(bowersock_N$`Date and time`, bowersock_N$`Nitrate plus nitrite as mg-N/L`, ylim = c(-1,5))
```
...
pullEnd <- as.POSIXct("2018-05-01", format = "%Y-%m-%d") # Date for end of data pull
