...
ggsave("./Plots/U.Vf_boxplot.png", grob, height = 4.25, width = 5.25, units = "in")
...
a <- 
  ...
  #                   limits = c("S1", "S2", "S3")) +
  # Axis labels
  xlab(bquote("Predicted U (g-N" ~ m^-2 ~ d^-1 ~ ")")) + 
  ylab(expression("U (g-N" ~~ m^{-2} ~ day^{-1} * ")")) +
  labs(tag = "a") +
  # Plot theme
  theme_classic() +
...
ggsave(grob, file = "./Plots/U_Upred.png", height = 3, width = 9.5, 
       units = "in")
```
...
ggsave("./Plots/Uptake_GPP.png", grob, height = 6, width = 5.75, 
       units = "in")
...
grob <- grid.arrange(a,b, ncol = 2)
ggsave("./Plots/Vf_GPP.png", grob, height = 6, width = 5.75,  units = "in")
```
