...
analyze.wavelet(desoto.w.data.apr, my.series = "DO.sat", 
                dt = 1/(4*24), lowerPeriod = 0.25, upperPeriod = 3,
...
analyze.wavelet(desoto.w.data, my.series = "DO.sat", 
                dt = 1/(4*24), lowerPeriod = 0.25, upperPeriod = 4,
                make.pval = TRUE, date.format = "%Y-%m-%d %H:%M:%S")
...
#cross wavelet power of april N data and DOsat
coher.apr.N.DOsat <- 
analyze.coherency(desoto.w.data.apr, my.pair = c(3,4), dt = 1/(4*24), 
                  date.format = "%Y-%m-%d %H:%M:%S")
wc.avg(coher.apr.N.DOsat, periodlab = "Period (days)")
# analyzing the phase difference
wc.sel.phases(coher.apr.N.DOsat, 
