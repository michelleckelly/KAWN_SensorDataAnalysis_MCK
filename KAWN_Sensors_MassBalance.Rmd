...
massBal$DINLoad.bowersock_kgNday <- 
  massBal$NitrateLoad.bowersock_kgNday + massBal$AmmoniumLoad.bowersock_kgNday
massBal$DINLoad.desoto_kgNday <- 
  massBal$NitrateLoad.desoto_kgNday + massBal$AmmoniumLoad.desoto_kgNday
massBal$DINLoad.steve_kgNday <- 
  massBal$NitrateLoad.steve_kgNday + massBal$AmmoniumLoad.steve_kgNday
massBal$DINLoad.eric_kgNday <- 
  massBal$NitrateLoad.eric_kgNday + massBal$AmmoniumLoad.eric_kgNday
