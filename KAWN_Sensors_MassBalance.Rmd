...
desoto$site <- NULL
colnames(desoto)[3:4] <- c("Ammonium.desoto_mgNL", "Ammonia.desoto_mgNL")

steve <- dplyr::full_join(steve, NH3_NH4 %>% dplyr::filter(site == "Steve"))
steve$site <- NULL
colnames(steve)[3:4] <- c("Ammonium.steve_mgNL", "Ammonia.steve_mgNL")

eric <- dplyr::full_join(eric, NH3_NH4 %>% dplyr::filter(site == "Eric"))
eric$site <- NULL
colnames(eric)[3:4] <- c("Ammonium.eric_mgNL", "Ammonia.eric_mgNL")

bowersock <- dplyr::full_join(bowersock, NH3_NH4 %>% dplyr::filter(site == "Bowersock"))
bowersock$site <- NULL
colnames(bowersock)[3:4] <- c("Ammonium.bowersock_mgNL", "Ammonia.bowersock_mgNL")
```
...
massBal$AmmoniaLoad.bowersock_kgNday <- 
  massBal$Q.lawrence_Ls * massBal$Ammonia.bowersock_mgNL / 1000 / 1000 * 60 * 60 * 24
massBal$AmmoniaLoad.desoto_kgNday <- 
  massBal$Q.desoto_Ls * massBal$Ammonia.desoto_mgNL / 1000 / 1000 * 60 * 60 * 24
massBal$AmmoniaLoad.steve_kgNday <- 
  massBal$Q.lawrence_Ls * massBal$Ammonia.steve_mgNL / 1000 / 1000 * 60 * 60 * 24
massBal$AmmoniaLoad.eric_kgNday <- 
  massBal$Q.lawrence_Ls * massBal$Ammonia.eric_mgNL / 1000 / 1000 * 60 * 60 * 24
...
ggplot(data = massBal, aes(x = date)) +
  #geom_line(aes(y = NitrateLoad.bowersock_kgNday, col = "NO3 + NO2"), size = 1) +
  ...
  geom_point(aes(y = AmmoniumLoad.bowersock_kgNday, col = "NH4"), shape = 24, size = 2.5, fill = "white") +
  #geom_line(data = massBal[!is.na(massBal$AmmoniaLoad.bowersock_kgNday),],
            #aes(y = AmmoniaLoad.bowersock_kgNday, col = "NH3"), size = 1) +
  geom_point(aes(y = AmmoniaLoad.bowersock_kgNday, col = "NH3"), shape = 22, size = 2.5) +
...
ggplot(data = massBal, aes(x = date)) +
  ...
  geom_point(aes(y = AmmoniaLoad.eric_kgNday, col = "NH3"), shape = 22, size = 2.5, fill = "white") +
  scale_x_date(limits = c(as_date("2018-02-01"), as_date("2018-05-30"))) + 
  scale_y_continuous(limits = c(0, 25000), labels = scales::scientific) +
  scale_color_manual(values = c("black", "red", "blue"), limits = c("NO3 + NO2", "NH4", "NH3")) +
  theme(legend.position = "none", panel.border = element_rect(color = "black", fill = NA)) +
...
ggplot(data = massBal, aes(x = date)) +
  ...
  geom_point(aes(y = AmmoniaLoad.steve_kgNday, col = "NH3"), shape = 22, size = 2.5, fill = "white") +
  scale_x_date(limits = c(as_date("2018-02-01"), as_date("2018-05-30"))) + 
  scale_y_continuous(limits = c(0, 25000), labels = scales::scientific) +
  scale_color_manual(values = c("black", "red", "blue"), limits = c("NO3 + NO2", "NH4", "NH3")) +
  theme(legend.position = "none", panel.border = element_rect(color = "black", fill = NA)) +
...
ggplot(data = massBal, aes(x = date)) +
  ...
  geom_point(aes(y = AmmoniaLoad.desoto_kgNday, col = "NH3"), shape = 22, size = 2.5, fill = "white") +
  scale_x_date(limits = c(as_date("2018-02-01"), as_date("2018-05-30"))) + 
  scale_y_continuous(limits = c(0, 25000), labels = scales::scientific) +
  scale_color_manual(values = c("black", "red", "blue"), limits = c("NO3 + NO2", "NH4", "NH3")) +
  theme(legend.position = "none", panel.border = element_rect(color = "black", fill = NA)) +
