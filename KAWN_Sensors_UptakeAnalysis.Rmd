...
variability.smoother <- function(uptake_data){
  ...
  # Interpolate gaps in data
  uptake_data$Nitrate_mgL <- imputeTS::na.interpolation(uptake_data$Nitrate_mgL)
  # Return datatframe
  return(uptake_data)
}
...
if (UptakeEqn == 1) {
  ...
  names(Uptake_Eqn1)[names(Uptake_Eqn1) == "NitrateSupply_gNm2day"] <- 
  ...
  Uptake_Eqn1$UaNO3_gNm2day.steve[Uptake_Eqn1$Date >= ymd("2018-03-10") &
