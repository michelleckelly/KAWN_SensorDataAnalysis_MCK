...
```{r thesis scaling by set length}
...
names(Uptake_Eqn1)[names(Uptake_Eqn1) == "calcdepth_m"] <- 
  "calcdepth_m.desoto"
names(Uptake_Eqn1)[names(Uptake_Eqn1) == "Max.PreDawnN_mgL"] <- 
  "Max.PreDawnN_mgL.desoto"
names(Uptake_Eqn1)[names(Uptake_Eqn1) == "Min.Nitrate_mgL"] <- 
  "Min.Nitrate_mgL.desoto"
names(Uptake_Eqn1)[names(Uptake_Eqn1) == "NitrateChange_Perc"] <- 
