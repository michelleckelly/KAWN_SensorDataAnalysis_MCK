...
# Eric
ggplot(data = UptakeMetab, aes(x = Mean.Nitrate_mgL.eric, y = UaGPP_gNm2day.eric)) +
  geom_point(shape = 21, fill = "white") +
  geom_smooth(formula = y~x, method = "lm", se = FALSE, fullrange = TRUE,
              color = "#FF0000") +
  facet_grid(.~ReleaseStatus) +
...
# Steve
ggplot(data = UptakeMetab, aes(x = Mean.Nitrate_mgL.steve, y = UaGPP_gNm2day.steve)) +
  geom_point(shape = 21, fill = "white") +
  geom_smooth(formula = y~x, method = "lm", se = FALSE, fullrange = TRUE,
              color = "#23baaf") +
  facet_grid(.~ReleaseStatus) +
...
# Desoto
ggplot(data = UptakeMetab, aes(x = Mean.Nitrate_mgL.desoto, y = UaGPP_gNm2day.desoto)) +
  geom_point(shape = 21, fill = "white") +
  geom_smooth(formula = y~x, method = "lm", se = FALSE, fullrange = TRUE,
              color = "#F2AD00") +
  facet_grid(.~ReleaseStatus) +
