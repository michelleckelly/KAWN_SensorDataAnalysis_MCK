...
UptakeMetab$Vf.NO3_mday.eric <- 
  UptakeMetab$UaNO3_gNm2day.eric / UptakeMetab$Mean.Nitrate_mgL.eric * 1000
UptakeMetab$Vf.NO3_mday.steve <- 
  UptakeMetab$UaNO3_gNm2day.steve / UptakeMetab$Mean.Nitrate_mgL.steve * 1000
UptakeMetab$Vf.NO3_mday.desoto <- 
  UptakeMetab$UaNO3_gNm2day.desoto / UptakeMetab$Mean.Nitrate_mgL.desoto * 1000
...
grid.arrange(
  ggplot(data = UptakeMetab, aes(x = Date)) +
    geom_point(aes(y = UaNO3_gNm2day.eric*10^6, color = "eric")) +
    geom_line(aes(y = UaNO3_gNm2day.eric*10^6, color = "eric")) +
    geom_point(aes(y = UaNO3_gNm2day.desoto*10^6, color = "desoto")) +
    geom_line(aes(y = UaNO3_gNm2day.desoto*10^6, color = "desoto")),
...
ggplot(data = NSupplyDemand, aes(x = Date)) +
  ...
  #geom_col(aes(y = NitrateLoad.desoto_kgNday/UaNO3_gNm2day.desoto)) +
