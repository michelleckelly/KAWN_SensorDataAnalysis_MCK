...
# Comparing during and post-release
# Eric
ggplot(data = UptakeMetab, aes(x = Date)) +
  # Desoto
  geom_point(aes(y = UaNO3_kgNm2day.eric, color = ReleaseStatus)) +
  geom_line(aes(y = UaNO3_kgNm2day.eric, color = ReleaseStatus)) +
  # axis and color scales
  #scale_y_continuous(limits = c(0, 500)) +
  scale_x_date(limits = c(as_date("2018-02-01"), as_date("2018-05-01")),
               date_breaks = "2 weeks", date_labels = "%b %e" ) +
  scale_color_manual(values = c("After" = "#000000", "During" = "#FF0000"),
  ...
  theme(panel.border = element_rect(color = "black", fill = NA),
        ...
        legend.background = element_rect(color = "black"))
ggsave(filename = "./Plots/Uptake_time_eric.png", device = "png", 
...
ggplot(data = UptakeMetab, aes(x = Date)) +
  # Desoto
  geom_point(aes(y = UaNO3_kgNm2day.steve, color = ReleaseStatus)) +
  geom_line(aes(y = UaNO3_kgNm2day.steve, color = ReleaseStatus)) +
  # axis and color scales
  scale_y_continuous(limits = c(0, 700)) +
  scale_x_date(limits = c(as_date("2018-02-01"), as_date("2018-05-01")),
               date_breaks = "2 weeks", date_labels = "%b %e" ) +
  scale_color_manual(values = c("After" = "#000000", "During" = "#23baaf"),
                     breaks = c("During", "After"),
                     name = "Release period") +
  scale_shape_manual(values = 21) +
  # axis labels
  ...
  theme(panel.border = element_rect(color = "black", fill = NA),
        legend.position = c(0.21, 0.83),
        legend.background = element_rect(color = "black"))
ggsave(filename = "./Plots/Uptake_time_steve.png", device = "png", 
       width = 3.75, height = 3.5, units = "in")

# Desoto
ggplot(data = UptakeMetab, aes(x = Date)) +
  # Desoto
  geom_point(aes(y = UaNO3_kgNm2day.desoto, color = ReleaseStatus)) +
  geom_line(aes(y = UaNO3_kgNm2day.desoto, color = ReleaseStatus)) +
  # axis and color scales
  scale_y_continuous(limits = c(0, 700)) +
  scale_x_date(limits = c(as_date("2018-02-01"), as_date("2018-05-01")),
               date_breaks = "2 weeks", date_labels = "%b %e" ) +
  scale_color_manual(values = c("After" = "#000000", "During" = "#F2AD00"),
                     breaks = c("During", "After"),
                     name = "Release period") +
  scale_shape_manual(values = 21) +
  # axis labels
  ...
  theme(panel.border = element_rect(color = "black", fill = NA),
        legend.position = c(0.21, 0.83),
        legend.background = element_rect(color = "black"))
ggsave(filename = "./Plots/Uptake_time_desoto.png", device = "png", 
       width = 3.75, height = 3.5, units = "in")


# Notes: seperate these dataframes so that the june data isnt in them
...
ggplot(data = UptakeMetab) +
  geom_point(aes(x = Mean.Nitrate_mgL.eric, y = UaNO3_kgNm2day.eric)) +
  geom_point(aes(x = Mean.Nitrate_mgL.steve, y = UaNO3_kgNm2day.steve)) +
  geom_point(aes(x = Mean.Nitrate_mgL.desoto, y = UaNO3_kgNm2day.desoto))

# Plotting GPP vs uptake
ggplot(data = UptakeMetab) +
  geom_point(aes(x = GPP.eric, y = UaNO3_kgNm2day.eric))
ggplot(data = UptakeMetab) +
  geom_point(aes(x = GPP.steve, y = UaNO3_kgNm2day.steve))
ggplot(data = UptakeMetab) +
  geom_point(aes(x = GPP.desoto, y = UaNO3_kgNm2day.desoto))
